...
**Pomiń, gdy**: użytkownik nadal pracuje nad pomysłami i nie ma notatek — najpierw wskaż `/10x-shape`. Pomiń również, gdy użytkownik chce _edytować_ istniejący PRD ręcznie — ta umiejętność zapisuje całe pliki; edycje chirurgiczne są poza zakresem.
